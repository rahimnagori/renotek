                  ...
                  <tbody>
                    <tr>
                      <td align="left" valign="top" style="color:#444;font-size:14px">
                        <?= $body; ?>
                        <p style="margin:0;padding:10px 0px">Kind regards,<br>The <?= $this->config->item('PROJECT'); ?> Team</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" valign="top" width="80%">
                        <div style="margin:0;padding:0;color:#fff;font-size:13px">Copyright © <?= date("Y"); ?> <a href="'.site_url().'" style="color:white;text-decoration:none"> <?= $this->config->item('PROJECT'); ?> </a>. All rights reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
